...
Write a short ordinary-language relation label that preserves the source meaning.
...
fact: cN | <ordinary-language relation label> | entity | cN
fact: cN | <ordinary-language relation label> | literal | <exact source literal>
