...
PROPOSITION_FRAGMENT_MEMBERSHIP_SCHEMA_ID = "proposition_fragment_membership_text_v1"
    ...
    for candidate in candidates:
        ...
        outcome = run_bounded_extraction(
            BoundedExtractionInput(
                ...
                validator_version="proposition_fragment_membership_validator_v1",
    ...
    *,
    ...
    planning = build_context_manifest(
        ContextManifestInput(
            ...
            prompt_id="source_grounded_proposition_fragment_membership_v1",
            prompt_bytes=command.prompt_bytes,
