# TDD: CEA-1.12 Runtime-Calibrated Finite Termination
...
**Mechanism Proof** means evidence about bounded runtime output behavior.
...
5. KoteKomi compares independent output-count witnesses and exact raw bytes.
...
- CEA112-MEC-04: The two output-count witnesses must agree for every execution.
...
- Runtime usage and probability positions remain separate output-count witnesses.
...
- CEA112-ACC-03: Tests prove both output-count witnesses must agree.
