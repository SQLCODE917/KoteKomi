...
- verify document semantic retrieval contracts, LM Studio/llama-server/Ollama embedding responses, isolated SQLite semantic indexes, and v2 canonical scenario routing with `uv run pytest packages/application/tests/test_document_retrieval.py packages/adapters/tests/test_lm_studio_embeddings.py packages/adapters/tests/test_llama_server_embeddings.py packages/adapters/tests/test_ollama_embeddings.py packages/adapters/tests/test_sqlite_document_retrieval.py packages/pipelines/tests/test_cli.py packages/devtools/tests/unit/test_retrieval_scenarios.py`
