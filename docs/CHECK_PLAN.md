...
- verify the byte-pinned PDF fixture corpus covers layout, OCR, mixed-page, table, font-mapping, encryption, corruption, fuzzing, and parser-coordinate cases with `uv run pytest packages/adapters/tests/test_pdf_fixture_corpus.py`
